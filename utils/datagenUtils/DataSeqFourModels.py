...
from ..utils import convertRowToDictionary

class DataSequenceFourModels(Sequence):
    ...
    def __getitem__(self, index):
        ...
        # Generate data
        image_x, text_x, comments_x, meta_x, global_y = self.__data_generation(df_batch, batch_indices)

        return [[image_x, text_x, comments_x, meta_x]], global_y
